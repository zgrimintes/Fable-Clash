...
public class AIAttacksGreuceanu : MonoBehaviour
{
    ...
    protected void checkHP()
    {
        ...
        else if (enemyController.HP > 10 && enemyController.HP < 14) attacks[4] += .2f;
        else if (enemyController.HP <= 15) attacks[4] += .1f;
    }
    ...
    protected void checkDistance()
    {
        ...
        {
            attacks[0] += .5f; attacks[1] += .5f; attacks[3] += .15f; attacks[2] += .15f;
        }
        else
        {
            attacks[2] += .6f;
